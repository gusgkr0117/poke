...
if __name__ == '__main__':
    ...
    f.write('\n')
    f.write('// p+1 divided by the power of 5\n')
    f.write(f'static digit_t p_cofactor_for_5h[{(((p+1)//5**POWER_OF_5).bit_length()-1)//64+1}] = {fp2str((p+1)//5**POWER_OF_5, (p+1)//5**POWER_OF_5+1)};\n')
    f.write(f'#define P_COFACTOR_FOR_5H_BITLENGTH {((p+1)//5**POWER_OF_5).bit_length()}\n')
    f.write('\n')
    ...
    f.write('\n')
    f.write('// p+1 divided by the powers of 3 and 5\n')
    f.write(f'static digit_t p_cofactor_for_35gh[{(((p+1)//3**POWER_OF_3//5**POWER_OF_5).bit_length()-1)//64+1}] = {fp2str((p+1)//3**POWER_OF_3//5**POWER_OF_5, (p+1)//3**POWER_OF_3//5**POWER_OF_5+1)};\n')
    f.write(f'#define P_COFACTOR_FOR_35GH_BITLENGTH {((p+1)//3**POWER_OF_3//5**POWER_OF_5).bit_length()}\n')
    f.write('\n')
