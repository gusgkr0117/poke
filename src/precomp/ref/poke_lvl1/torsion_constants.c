...
const ibz_t TORSION_PLUS_3CPOWER = {{._mp_alloc = 0, ._mp_size = 19, ._mp_d = (mp_limb_t[]) {0x4a29,0x32fb,0x359f,0x1e9a,0x4ce8,0x8c98,0xf67f,0xbf79,0x8a3b,0x756c,0xc9fd,0xab7f,0x8bd2,0xe286,0x2339,0x6309,0x348,0xfa0c,0x3505}}};
const ibz_t TORSION_PLUS_2CPOWER = {{._mp_alloc = 0, ._mp_size = 11, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd3b2,0x5b59,0x6f0}}};
const ibz_t TORSION_PLUS_23CPOWER = {{._mp_alloc = 0, ._mp_size = 27, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x9452,0x65f6,0x6b3e,0x3d34,0x99d0,0x1930,0xecff,0x7ef3,0x1477,0xead9,0x93fa,0x56ff,0x17a5,0xc50d,0x4673,0xc612,0x690,0xf418,0x6a0b}}};
...
const ibz_t TORSION_PLUS_3CPOWER = {{._mp_alloc = 0, ._mp_size = 10, ._mp_d = (mp_limb_t[]) {0x32fb4a29,0x1e9a359f,0x8c984ce8,0xbf79f67f,0x756c8a3b,0xab7fc9fd,0xe2868bd2,0x63092339,0xfa0c0348,0x3505}}};
const ibz_t TORSION_PLUS_2CPOWER = {{._mp_alloc = 0, ._mp_size = 6, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x0,0x0,0x5b59d3b2,0x6f0}}};
const ibz_t TORSION_PLUS_23CPOWER = {{._mp_alloc = 0, ._mp_size = 14, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x0,0x0,0x65f69452,0x3d346b3e,0x193099d0,0x7ef3ecff,0xead91477,0x56ff93fa,0xc50d17a5,0xc6124673,0xf4180690,0x6a0b}}};
...
const ibz_t TORSION_PLUS_3CPOWER = {{._mp_alloc = 0, ._mp_size = 5, ._mp_d = (mp_limb_t[]) {0x1e9a359f32fb4a29,0xbf79f67f8c984ce8,0xab7fc9fd756c8a3b,0x63092339e2868bd2,0x3505fa0c0348}}};
const ibz_t TORSION_PLUS_2CPOWER = {{._mp_alloc = 0, ._mp_size = 3, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x6f05b59d3b2}}};
const ibz_t TORSION_PLUS_23CPOWER = {{._mp_alloc = 0, ._mp_size = 7, ._mp_d = (mp_limb_t[]) {0x0,0x0,0x3d346b3e65f69452,0x7ef3ecff193099d0,0x56ff93faead91477,0xc6124673c50d17a5,0x6a0bf4180690}}};
